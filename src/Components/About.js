...
const About = () => {
  return (
    ...
    <h2>LEADERSHIP</h2>
    <ul>
        <li>Manu Manek, Chief Development Officer</li>
        <li>Ajay kedia, VP of Sales</li>
        <li> Rakesh Jhunjhunwala, VP of Customer Success</li>
        <li> Harshad Shantilal Mehta, Director of Marketing</li>
